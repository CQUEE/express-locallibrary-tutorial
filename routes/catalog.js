...
const book_controller = require("../controls/bookController");
const author_controller = require("../controls/authorController");
const genre_controller = require("../controls/genreController");
const bookinstance_controller = require("../controls/bookinstanceController");
